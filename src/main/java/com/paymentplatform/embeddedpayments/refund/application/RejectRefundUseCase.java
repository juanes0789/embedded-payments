...
public class RejectRefundUseCase {
    ...
    public RejectRefundUseCase(RefundRepository refundRepository,
    ...
    public Refund execute(UUID merchantId, UUID refundId) {
        ...
        // mark refund rejected
        Refund updated = new Refund(refund.getId(), refund.getTransactionId(), refund.getAmount(), refund.getReason(), "REJECTED");
        Refund saved = refundRepository.save(updated);

        // revert transaction to SUCCEEDED
        transaction.cancelRefundRequest();
