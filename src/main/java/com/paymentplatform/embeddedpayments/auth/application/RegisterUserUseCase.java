...
public class RegisterUserUseCase {
    ...
    public RegisteredUser execute(String email, String password, String role, String merchantName) {
        ...
        UUID merchantId = registeredMerchant.merchant().getId();
        String apiKey = registeredMerchant.apiKey();
    ...
    private String normalizeRole(String role) {
        ...
        if (!ADMIN.equals(normalized) && !MERCHANT.equals(normalized)) {
            throw new DomainException(
                    HttpStatus.BAD_REQUEST,
                    "INVALID_ROLE",
                    "Role must be ADMIN or MERCHANT",
                    List.of("role: " + role)
            );
        }
        return normalized;
